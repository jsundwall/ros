...
var game = new Phaser.Game(400, 711, Phaser.AUTO, 'flappy-bird-reborn');
...
var Ground = function(game, x, y, width, height) {
  Phaser.TileSprite.call(this, game, x, y, 400, height, 'ground');
...
var Scoreboard = function(game) {
  ...
  this.startButton = this.game.add.button(this.game.width/2, 300, 'replayButton', this.startClick, this);
  this.startButton.anchor.setTo(0.5,0.5);

  //this.goBackButton = this.game.add.button(this.game.width/2 - 100, 300, 'startButton', this.startClick, this);
...
/*Scoreboard.prototope.goBack = function() {
...
Menu.prototype = {
  ...
  create: function() {
    ...
    this.ground = this.game.add.tileSprite(0,600, 400,112,'ground');
    ...
    this.bird = this.add.sprite(140,50,'bird');
    ...
    this.goBackButton = this.game.add.button(this.game.width/2 - 100, 300, 'goBack', this.goBack, this);
    this.goBackButton.anchor.setTo(0.5,0.5);
  },
  startClick: function() {
...
Play.prototype = {
  create: function() {
    ...
    this.ground = new Ground(this.game, 0, 600, 400, 112);
